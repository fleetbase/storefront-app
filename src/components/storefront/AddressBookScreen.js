...
const StorefrontAddressBookScreen = ({ navigation, route }) => {
    return (
        <SafeAreaView style={tailwind('bg-white')}>
            <View style={tailwind('w-full h-full bg-white relative')}>
                <View style={tailwind('flex flex-row items-center p-4')}>
                    ...
                    <Text style={tailwind('text-xl font-semibold')}>Your address book</Text>
                </View>
...
export default StorefrontAddressBookScreen;
