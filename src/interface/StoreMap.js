...
const StoreMap = ({ query, location, filters, onPressStore, containerStyle }) => {
            ...
            {userLocation && (
                ...
                >
                    {storeLocations.map((storeLocation, index) => (
                        ...
                        >
                            <TouchableOpacity onPress={() => onPressStore(storeLocation.getAttribute('store'), storeLocation)} style={tailwind('flex items-center')}>
